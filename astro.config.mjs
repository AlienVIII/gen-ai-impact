			...
			sidebar: [
				{
					...
					items: [
						...
						{
							label: '10. Personal Distillation: Build Your Own AI Knowledge Base',
							translations: { vi: '10. Chưng cất bản thân: Tự build knowledge base cho AI' },
							slug: 'topics/personal-distillation-ai-knowledge-base',
						},
						{
							label: '11. Agent Workflow: Task List, Handoff, Proof',
							translations: { vi: '11. Agent workflow: Task list, handoff, proof' },
							slug: 'topics/agent-workflow-task-list-handoff-proof',
						},
						{
							label: '12. Source Triage: Links Are Leads, Not Evidence',
							translations: { vi: '12. Source triage: Link chỉ là lead, chưa phải evidence' },
							slug: 'topics/source-triage-links-are-not-evidence',
						},
						{
							label: '13. Forward-deployed Engineering: AI Pushes Engineers Closer To The Work',
							translations: { vi: '13. Forward-deployed engineering: AI kéo engineer gần business hơn' },
							slug: 'topics/forward-deployed-engineering-business-context',
						},
						{
							label: '14. Tool Hype: Evaluate Agent Harnesses, Not Stars',
							translations: { vi: '14. Tool hype: Đánh giá agent harness, đừng nhìn stars' },
							slug: 'topics/tool-hype-and-agent-harness-evaluation',
						},
						{
							label: '15. AI-generated OSS Contributions Need Human Ownership',
							translations: { vi: '15. OSS contribution bằng AI cần human ownership' },
							slug: 'topics/ai-generated-open-source-contributions',
						},
						{
							label: '16. Cognitive Debt: Keep The Human Skill Alive',
							translations: { vi: '16. Cognitive debt: Giữ skill của human còn sống' },
